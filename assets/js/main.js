    ...
    if (mobileBtn) {
        mobileBtn.addEventListener('click', () => {
            ...
            menu.innerHTML = `
                ...
                <button onclick="location.href='https://app.payfactu.com/login'; document.getElementById('mobile-menu').remove()" 
                        class="mt-3 w-full bg-slate-900 text-white py-3 rounded-2xl font-semibold">Acceso Clientes</button>
            `;
